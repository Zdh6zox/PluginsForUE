...
public:
	...
	void SetKeyDown(const FKeyEvent& KeyEvent, bool bIsDown) { SetKeyDown(KeyEvent.GetKey(), bIsDown); }
	...
	// @param bIsDown - True, if key is down
	void SetGamepadNavigationKey(const FKeyEvent& KeyEvent, bool bIsDown) { SetKeyDown(KeyEvent.GetKey(), bIsDown); }
	...
	TArray<FKeyEvent> KeyDownEvents;
	TArray<FKeyEvent> KeyUpEvents;
	TArray<FAnalogInputEvent> AnalogInputEvents;
